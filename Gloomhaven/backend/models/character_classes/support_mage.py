...
magic_user_cards = [
    actions.ActionCard(
        ...
        actions=[actions.SingleTargetAttack(4, 3), actions.CurseAllEnemies(3)],
        movement=1,
        jump=False,
    ),
    actions.ActionCard(
    ...
    actions.ActionCard(
        ...
        actions=[actions.SingleTargetAttack(2, 4), actions.WeakenEnemy(2, 4)],
        movement=1,
        jump=False,
    ),
    actions.ActionCard(
        attack_name="Protective Aura",
        actions=[actions.ShieldAllAllies(2, 2, 3), actions.BlessSelf()],
        movement=1,
        jump=False,
    ),
    actions.ActionCard(
        attack_name="Banishing Ward",
        actions=[actions.ShieldSelf(2, 2), actions.BlessSelf(), actions.Teleport(3)],
        movement=2,
        jump=True,
    ),
    actions.ActionCard(
